...
<body>
    ...
    <script>
        ...
        form.addEventListener('submit', async (e) => {
            ...
            // Add LLM preprocessing if enabled
            ...
            if (enableLLM) {
                ...
                requestBody.llm_endpoint = llmEndpoint;
                requestBody.optimize_for_tts = optimizeForTTS;
                requestBody.add_ssml_markup = addSSMLMarkup;
            }
